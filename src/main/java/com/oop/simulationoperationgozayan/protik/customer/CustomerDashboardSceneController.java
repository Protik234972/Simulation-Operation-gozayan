package com.oop.simulationoperationgozayan.protik.customer;
...
public class CustomerDashboardSceneController {
    ...
    public void logoutButtonOnClicked(ActionEvent actionEvent)  throws IOException {
        Parent scene2Parent = FXMLLoader.load(Objects.requireNonNull(getClass().getResource("/com/oop/simulationoperationgozayan/login/LoginScene.fxml")));
    ...
    @javafx.fxml.FXML
    public void flightBookingButtonOnClicked(ActionEvent actionEvent) {
    }
}
